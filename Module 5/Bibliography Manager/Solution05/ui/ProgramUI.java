...
class ProgramUI
{
    ...
    void reportArticlesFromYear()
    {
        ...
        if (!BibliographyDatabase.printJournalArticlesFromYear(year))
        {
    ...
    {
        if (!BibliographyDatabase.getIssueMasterList().isEmpty())
        {
            ...
            BibliographyDatabase.getIssueMasterList().get(choiceIndex).addArticle(title, author);            
        }
    }
    ...
    void findAuthorWithMostArticles()
    {
        ...
        {
            System.out.println("The most published author is " + BibliographyDatabase.getMostFrequentAuthor());
        }
        else
        {
    ...
    public static void main(String[] args)
    {
        ...
        BibliographyDatabase.addListOfJournals(journalList);

        // Make a new program and kickstart it
        ProgramUI ui = new ProgramUI(RunningProgram.getSampleProgram());
        ui.runProgram();
    }
}